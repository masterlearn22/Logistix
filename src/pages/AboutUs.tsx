...
const projects = [
  {
    ...
    image: import.meta.env.BASE_URL + "images/project_titan.png",
  ...
  },
  {
    ...
    image: import.meta.env.BASE_URL + "images/project_coldchain.png",
  ...
  },
  {
    ...
    image: import.meta.env.BASE_URL + "images/project_aerolift.png",
  ...
  return (
    <div className="min-h-screen bg-brand-surface selection:bg-amber-500 selection:text-brand-dark overflow-hidden">
      ...
      <section className="bg-brand-dark text-white py-24 px-6 relative">
        <div className="absolute inset-0 bg-cover bg-center opacity-20 mix-blend-luminosity" style={{ backgroundImage: `url(${import.meta.env.BASE_URL}images/about_hero_bg.png)` }}></div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="md:col-span-2 bg-brand-dark rounded-3xl p-8 text-white flex items-center relative overflow-hidden">
              <div className="absolute inset-0 bg-cover opacity-20" style={{ backgroundImage: `url(${import.meta.env.BASE_URL}images/innovation_bg.png)` }}></div>
